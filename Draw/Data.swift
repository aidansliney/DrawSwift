...
let bookData = [
    ...
    Book(bookname: "Book03", level: "Texas Hold 'em Poker",h1:"Learn hosuperhero", rating: 2, cover: "b03isocover", tutorial: book1Tutorials),
    Book(bookname:"Book04", level:"Tic-Tac-Toe",h1:"Learn how to draw erhero", rating: 4, cover: "b04isocover", tutorial: book2Tutorials),
    Book(bookname: "Book05", level: "Spin the Bottle",h1:"Learn how  superhero", rating: 5, cover: "b05isocover", tutorial: book2Tutorials),
    Book(bookname: "Book06", level: "Texas Hold 'em Poker",h1:"Learn howsuperhero", rating: 2, cover: "b06isocover", tutorial: book2Tutorials),
    Book(bookname:"Book07", level:"Tic-Tac-Toe",h1:"Learn how to draw arhero", rating: 4, cover: "b07isocover", tutorial: book2Tutorials)]
